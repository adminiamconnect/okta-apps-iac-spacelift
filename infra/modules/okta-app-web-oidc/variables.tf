...
variable "grant_types" { type = list(string) default = ["authorization_code", "refresh_token"] }
variable "response_types" { type = list(string) default = ["code"] }
variable "consent_method" { type = string default = "TRUSTED" }
